...
from pydiffbmp.util.utils import set_global_seed, gaussian_blur
...
def process_combination(args):
    ...
    if renderer_name == "MseRenderer":
        from pydiffbmp.core.renderer.mse_renderer import MseRenderer
...
def run_comparison(initializers_configs, renderer_names, config, I_target, svg_loader, device):
    ...
    for init_name, init_config in initializers_configs:
        ...
        if init_name == "StructureAwareInitializer":
            ...
            from pydiffbmp.core.initializer.multilevel_initializer import MultiLevelInitializer
